...
public class Menu extends Login  {
	...
	private void initialize() {
		...
		JLabel lblCashierJoaneStafannie = new JLabel("CASHIER \r");
		lblCashierJoaneStafannie.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblCashierJoaneStafannie.setBounds(21, 137, 133, 52);
		frmRestaurantRecept.getContentPane().add(lblCashierJoaneStafannie);
		...
		JLabel lblJoaneStafannie = new JLabel("JOANE STAFANNIE");
		lblJoaneStafannie.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblJoaneStafannie.setBounds(21, 103, 182, 52);
		frmRestaurantRecept.getContentPane().add(lblJoaneStafannie);
	}
}
